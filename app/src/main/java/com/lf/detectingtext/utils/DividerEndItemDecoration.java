...
/**
 * Created by Lucas on 30/3/17.
 */

public class DividerEndItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerEndItemDecoration(int offsetPx) {
        mOffsetPx = offsetPx;
    }
     ...
     *                       RecyclerView
     */
    public DividerEndItemDecoration(Drawable offsetDrawable) {
